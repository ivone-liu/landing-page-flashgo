  ...
  return (
    <section className="flex flex-col justify-center max-w-[88%] items-center py-16 gap-12">
      <div className="flex flex-col text-center gap-4">
        <h2 className="text-center"><a href="https://flashgo.s3.bitiful.net/flashgo-1.1.3-for-silicon.zip" target="_blank">{locale.title}</a></h2>
        <h2 className="text-center"><a href="https://flashgo.s3.bitiful.net/flashgo-1.1.3-for-intel.zip" target="_blank">{locale.title1}</a></h2>
